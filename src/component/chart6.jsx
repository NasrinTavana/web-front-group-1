...
setstate1(!Stats1)
    ...
    return(
        ...
        <div className=" d-flex mt-2 me-4" >
            ...
            <div className="bg-white col-xl-4 chart6-bg mt-2 ">
                ...
                <div className="d-flex me-3 chart6-list1">
                    <div className="d-flex flex-column align-items-center">
                        <img className="img-fluid m-2 p-2" src="./image/1.png" />
                        <p className="m-0">Samuel</p>
                        <p className="chart6-p">@samuel15</p>
                    </div>
                    <div className="d-flex flex-column align-items-center">
                        <img className="img-fluid m-2 p-2" src="./image/2.png" />
                        <p className="m-0">Samuel</p>
                        <p className="chart6-p">@samuel15</p>
                    </div>
                    <div className="d-flex flex-column align-items-center">
                        <img className="img-fluid m-2 p-2" src="./image/3.png" />
                        <p className="m-0">Samuel</p>
                        <p className="chart6-p">@samuel15</p>
                    </div>
                    <div className="d-flex flex-column align-items-center">
                        <img className="img-fluid m-2 p-2 " src="./image/4.png" />
                        <p className="m-0">Samuel</p>
                        <p className="chart6-p">@samuel15</p>
                    </div>
                </div>
                ...
                <div className="bg-white col-xl-8 mt-2 ps-2 ms-4">
